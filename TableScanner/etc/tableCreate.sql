...
CREATE TABLE MEMBER (
   ...
   MEMBER_BIRTHDAT VARCHAR2(7) NOT NULL, /* 생년월일 */
...
CREATE TABLE RESTAURANT (
   ...
   BUSINESS_NUM NUMBER NOT NULL, /* 사업자번호 */
   RESTAURANT_NAME VARCHAR(200), /* 음식점명 */
...
CREATE TABLE TABLE_ (
   ...
   TABLE_SEATS NUMBER, /* 인원 */
   LATITUDE NUMBER, /* X좌표 */
   LONGITUDE NUMBER, /* Y좌표 */
   BUSINESS_ID VARCHAR2(20), /* 점주 회원 아이디 */
...
CREATE TABLE ORDER_TABLE (
   TABLE_seq NUMBER NOT NULL, /* 테이블리스트번호 */
   RESERVATION_NUM NUMBER NOT NULL, /* 예약리스트번호 */
   CONSTRAINT PK_ORDER_TABLE PRIMARY KEY (TABLE_seq,RESERVATION_NUM)
);

/* 예약 */
CREATE TABLE RESERVATION (
   RESERVATION_NUM NUMBER NOT NULL, /* 예약리스트번호 */
   RESERVATION_DATE DATE, /* 예약날짜 */
   NUMBER_OF_PEOPLE NUMBER, /* 인원 */
   RESERVATION_WANTED_TIME DATE, /* 예약원하는시간 */
   RESERVATION_PAID_TIME DATE, /* 예약결제완료한시간 */
   RESERVATION_PAY_STATEMENT VARCHAR2(20), /* 결제유무 */
   RESERVATION_PRICE NUMBER, /* 예약금액 */
...
CREATE TABLE BOARD (
   ...
   BOARD_WRITING_TIME DATE DEFAULT sysdate, /* 작성시간 */
...
CREATE TABLE COMMEN (
   ...
   WIRTER_ID VARCHAR2(16), /* 작성자아이디 */
   COMMEN_CONTEXT VARCHAR2(100), /* 댓글내용 */
   COMMEN_WRITING_TIME DATE DEFAULT sysdate, /* 작성시간 */
...
CREATE TABLE REVIEW (
   ...
   REVIEW_CONTENT VARCHAR2(1500), /* 내용 */
   REVIEW_WRITE_TIME DATE, /* 작성시간 */
   REVEIW_IMAGE VARCHAR2(36), /* 리뷰사진 */
   MEMBER_ID VARCHAR2(20), /* 회원아이디 */
   BUSINESS_ID VARCHAR2(20), /* 점주 회원 아이디 */
   RESERVATION_NUM NUMBER, /* 예약리스트번호 */
...
CREATE TABLE RECOMMEND (
   RECOMMENT_NUM NUMBER NOT NULL, /* 추천리스트번호 */
   RECOMMENDER_ID VARCHAR2(12), /* 추천인아이디 */
   REVEIW_NUM NUMBER, /* 후기 글번호 */
   CONSTRAINT PK_RECOMMEND PRIMARY KEY (RECOMMENT_NUM)
);
